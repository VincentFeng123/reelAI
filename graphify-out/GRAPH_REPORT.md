...
## Corpus Check
- 388 files · ~1,061,327 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6608 nodes · 17879 edges · 202 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 6162 edges (avg confidence: 0.5)
...
Cohesion: 0.01
Nodes (417): _arc_verify_enabled(), ArcCandidate, ArcCheckLLM, ArcVerifyLLM, _concepts(), detect_arcs(), _pair_practice_prompts(), Deterministic instructional-arc detection (Wave 2 P3a).  Scans the time-ordered (+409 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (312): AssessmentCancelledError, AssessmentService, _BackfillPlan, Adaptive recall-check persistence, readiness, and session lifecycle., Promote one named level after sustained, broad mastery evidence.          Manual, Validate and persist one private answer-bearing question for a reel., Choose a stable 2-5 reel cadence, then adapt it to current evidence., Record one distinct forward navigation without changing watch analytics. (+304 more)
...
Cohesion: 0.02
Nodes (45): BaseSettings, get_settings(), Settings, _ChainBufferingEmitter, _difficulty(), _get_punct_pipeline(), _has_selection_contract(), _importance_ranker_enabled() (+37 more)
...
Cohesion: 0.02
Nodes (185): _jsonable(), Run-artifact persistence (W25-G): every assembled run leaves an auditable trail., Best-effort JSON projection: dataclass → asdict, pydantic → model_dump,     dict, Persist one assembled run's plan/arcs/shipped/ledger under     ``<work_dir>/<vid, write_run_artifacts(), _apply_metadata_signal(), detect_content_type(), _metadata_entertainment_hit() (+177 more)
...
Cohesion: 0.02
Nodes (115): extract_concepts(), _extract_concepts_via_llm(), Extract higher-quality concepts via Gemini (falling back to Groq)., _summary_for_terms(), _adapt_query_for_postgres(), _connect_postgres_with_retry(), _database_url(), _db_path() (+107 more)

### Community 12 - "Community 12"
Cohesion: 0.03
Nodes (72): BaseAdapter, CompletenessContract, ContractElement, Adapter framework core (spec §4, §11).  An *adapter* parameterizes the structure, RoleSpec, _rs(), BaseAdapter, CodingAdapter (+64 more)
...
Cohesion: 0.04
Nodes (69): fetch_chapters(), main(), make_skeleton(), merge_chapters_into_golden(), Dump a golden *skeleton* from the predicted structure, for a human to correct (s, MERGE {"chapters", "chapters_provenance": "creator"} into <golden_dir>/<video_id, Import creator chapters for each id; report + write nothing when a video has non, Creator chapters via the yt_dlp Python API — metadata only     (``extract_info(d (+61 more)
...
Cohesion: 0.04
Nodes (31): _prepared(), A source/caption edge is not proof of an in-cue semantic handoff., test_background_noise_above_required_threshold_is_unavailable(), test_backward_search_stitches_short_quiet_fragments_across_window_seam(), test_caption_handoff_does_not_scan_an_entire_inter_caption_gap(), test_caption_handoff_never_moves_cuts_inside_required_speech(), test_caption_handoff_never_skips_sound_before_a_late_start_quiet_run(), test_caption_handoff_observation_accepts_only_the_straddling_quiet_run() (+23 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (56): _build_cache_key(), _build_cerebras_client(), _build_gemini_module(), _build_groq_client(), _build_ollama_client(), _cerebras_chat(), chat_completion(), _collect_gemini_api_keys() (+48 more)
...
Cohesion: 0.1
Nodes (29): _acoustic_boundary_plan(), _acoustic_range_is_safe(), _cli_main(), _direct_adapter_duration_sec(), _discover(), _grounded_topic_evidence_quote(), _is_valid_timestamped_supadata_transcript(), _literal_source_quote() (+21 more)
...
- **Why does `ReelService` connect `Community 4` to `Community 1`, `Community 8`, `Community 10`, `Community 53`, `Community 94`, `Community 90`, `Community 62`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `Sentence` connect `Community 0` to `Community 96`, `Community 1`, `Community 100`, `Community 5`, `Community 101`, `Community 7`, `Community 9`, `Community 12`, `Community 19`, `Community 116`, `Community 21`, `Community 121`, `Community 93`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `IngestTranscriptCue` connect `Community 1` to `Community 88`, `Community 154`, `Community 11`, `Community 4`?**
