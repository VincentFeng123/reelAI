...
## Corpus Check
- 388 files · ~1,049,403 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6482 nodes · 17419 edges · 205 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 5935 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## God Nodes (most connected - your core abstractions)
1. `Sentence` - 204 edges
...
Cohesion: 0.01
Nodes (500): _arc_verify_enabled(), ArcCandidate, ArcCheckLLM, ArcVerifyLLM, _concepts(), detect_arcs(), _pair_practice_prompts(), Deterministic instructional-arc detection (Wave 2 P3a).  Scans the time-ordered (+492 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (338): AssessmentCancelledError, AssessmentService, _BackfillPlan, Adaptive recall-check persistence, readiness, and session lifecycle., Promote one named level after sustained, broad mastery evidence.          Manual, Validate and persist one private answer-bearing question for a reel., Choose a stable 2-5 reel cadence, then adapt it to current evidence., Record one distinct forward navigation without changing watch analytics. (+330 more)
...
Cohesion: 0.03
Nodes (155): _apply_enrichment(), _Assessment, _AssessmentDraft, _authoritative_pro(), _boundary_prompts(), _boundary_repair_prompts(), _BoundaryPlan, _BoundaryRepairCandidate (+147 more)
...
Cohesion: 0.06
Nodes (39): get_ingest_logger(), log_event(), new_trace_id(), Structured logging for the ingestion pipeline.  Every log line emitted from inge, Injects the current trace_id into every log record., Return a logger with the trace_id filter attached.      We install the filter id, Generate a fresh trace id. Callers store it via `set_trace_id()`., Set the current trace id for subsequent log calls in this task.      If `trace_i (+31 more)
...
- **Why does `ReelService` connect `Community 4` to `Community 1`, `Community 7`, `Community 10`, `Community 53`, `Community 90`, `Community 63`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Sentence` connect `Community 0` to `Community 1`, `Community 100`, `Community 5`, `Community 6`, `Community 101`, `Community 9`, `Community 16`, `Community 118`, `Community 123`, `Community 93`, `Community 95`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `IngestTranscriptCue` connect `Community 1` to `Community 89`, `Community 4`, `Community 157`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Are the 198 inferred relationships involving `Sentence` (e.g. with `Precise boundary refinement with targeted Whisper.  Supadata gives fast but coar` and `Absolute time of the lowest-RMS ``frame_ms`` frame within ``[a, b]`` — the quiet`) actually correct?**
  _`Sentence` has 198 INFERRED edges - model-reasoned connections that need verification._
