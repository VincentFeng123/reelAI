...
## Corpus Check
- 388 files · ~1,048,441 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6471 nodes · 17387 edges · 204 communities detected
...
Cohesion: 0.01
Nodes (473): _arc_verify_enabled(), ArcCandidate, ArcCheckLLM, ArcVerifyLLM, _concepts(), detect_arcs(), _pair_practice_prompts(), Deterministic instructional-arc detection (Wave 2 P3a).  Scans the time-ordered (+465 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (328): AssessmentCancelledError, AssessmentService, _BackfillPlan, Adaptive recall-check persistence, readiness, and session lifecycle., Promote one named level after sustained, broad mastery evidence.          Manual, Validate and persist one private answer-bearing question for a reel., Choose a stable 2-5 reel cadence, then adapt it to current evidence., Record one distinct forward navigation without changing watch analytics. (+320 more)
...
Cohesion: 0.01
Nodes (209): _energy_min_snap(), _ensure_audio(), _gap_after(), _gap_before(), _pick_end(), _pick_start(), Precise boundary refinement with targeted Whisper.  Supadata gives fast but coar, Absolute time of the lowest-RMS ``frame_ms`` frame within ``[a, b]`` — the quiet (+201 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (53): BaseSettings, get_settings(), Settings, _ChainBufferingEmitter, _difficulty(), _get_punct_pipeline(), _has_selection_contract(), _importance_ranker_enabled() (+45 more)
...
Cohesion: 0.03
Nodes (95): extract_concepts(), _extract_concepts_via_llm(), Extract higher-quality concepts via Gemini (falling back to Groq)., _summary_for_terms(), _adapt_query_for_postgres(), _connect_postgres_with_retry(), _database_url(), _db_path() (+87 more)

### Community 14 - "Community 14"
Cohesion: 0.04
Nodes (72): _anchor(), _run_gate(), _sent(), test_card5_no_introducer_no_rescue_kill_stands(), test_card5_no_suppress_when_subject_absent(), test_card5_seeds_from_introducer_when_not_in_referential(), test_card5_suppress_when_first_sentence_names_anchor_concept(), test_card5_suppress_when_first_sentence_names_topic() (+64 more)
...
- **Why does `ReelService` connect `Community 4` to `Community 1`, `Community 10`, `Community 49`, `Community 87`, `Community 59`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Sentence` connect `Community 0` to `Community 1`, `Community 97`, `Community 3`, `Community 98`, `Community 6`, `Community 9`, `Community 17`, `Community 116`, `Community 121`, `Community 90`, `Community 92`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `IngestTranscriptCue` connect `Community 1` to `Community 156`, `Community 4`, `Community 85`, `Community 22`?**
