...
## Corpus Check
- 388 files · ~1,048,327 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6470 nodes · 17385 edges · 204 communities detected
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 5934 edges (avg confidence: 0.5)
...
Cohesion: 0.02
Nodes (320): _BackfillPlan, Adaptive recall-check persistence, readiness, and session lifecycle., Promote one named level after sustained, broad mastery evidence.          Manual, Validate and persist one private answer-bearing question for a reel., Choose a stable 2-5 reel cadence, then adapt it to current evidence., Record one distinct forward navigation without changing watch analytics., Use a savepoint so multi-row assessment writes cannot be half-persisted., cue_text() (+312 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (67): BaseSettings, get_settings(), Settings, Exception, APIStatusError, BadRequestError, chat(), get_client() (+59 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (215): _activate_generation(), _adaptive_min_relevance_floor(), answer_assessment(), _auto_verify_community_account_if_allowed(), _bare_video_id(), _build_allowed_origins(), _build_generation_head_id(), can_generate_reels() (+207 more)
...
Cohesion: 0.02
Nodes (137): _energy_min_snap(), _ensure_audio(), _gap_after(), _gap_before(), _pick_end(), _pick_start(), Precise boundary refinement with targeted Whisper.  Supadata gives fast but coar, Absolute time of the lowest-RMS ``frame_ms`` frame within ``[a, b]`` — the quiet (+129 more)

### Community 6 - "Community 6"
Cohesion: 0.14
Nodes (135): AssessmentCancelledError, AssessmentService, _atomic_write(), _available_questions(), _cadence_session_id(), _cadence_target(), _check_cancelled(), _completed_rows() (+127 more)
...
Cohesion: 0.02
Nodes (17): QueryCandidate, MediumRegressionTests, Bug 1B: final_unique_reels should increment, not stay at max(current, 1)., Bug 1C: _bootstrap_pool_is_weak should not check has_transcript (never set on ca, Bug 1E: Empty search results should only be cached for 15 minutes, not 2 hours., Quality 5A: Known educational channels should get 'known_educational' tier., Niche 4A: Datamuse should be called for opaque topics, with results filtered., Niche 4C: New static topics should be in STATIC_TOPIC_SUBTOPICS. (+9 more)
...
Cohesion: 0.04
Nodes (78): AnchorAdapter, _built_budget(), _run_repair(), test_closure_budget_clamped_to_ship_cap(), test_closure_budget_smaller_closure_span_wins(), test_repair_expansion_capped_at_ship_cap(), test_repair_expansion_smaller_closure_span_wins(), _anchor() (+70 more)
...
Cohesion: 0.03
Nodes (84): extract_concepts(), _extract_concepts_via_llm(), Extract higher-quality concepts via Gemini (falling back to Groq)., _summary_for_terms(), _adapt_query_for_postgres(), _connect_postgres_with_retry(), _database_url(), _db_path() (+76 more)
...
Cohesion: 0.06
Nodes (75): _call_telemetry(), _cancel_requested(), _create_client(), _default_gemini3_thinking_level(), _error_code(), _exception_headers(), _field(), _finish_reason() (+67 more)
...
Cohesion: 0.1
Nodes (46): _discovery(), _one_cue_selector_result(), _pipeline(), _pipeline_with_semantic(), _plan(), _quality_clip(), test_acoustic_boundary_plan_fails_closed_for_missing_cue_ids(), test_acoustic_failure_is_stored_but_never_emitted() (+38 more)
...
Cohesion: 0.08
Nodes (12): _blend_engine_out(), _build_engine_out(), _clip_side_effect(), _difficulty_engine_out(), _fractional_engine_out(), IngestTopicProgressTests, IngestTopicTests, _no_difficulty_engine_out() (+4 more)
...
Cohesion: 0.17
Nodes (26): _age_seconds(), _ai_term_rejection(), AIQueryExpansion, _append_unique(), build_search_query_plan(), _cache_key(), _clean(), _lexically_coherent() (+18 more)
...
- **Why does `ReelService` connect `Community 2` to `Community 1`, `Community 6`, `Community 10`, `Community 51`, `Community 88`, `Community 60`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `Sentence` connect `Community 0` to `Community 1`, `Community 98`, `Community 99`, `Community 4`, `Community 5`, `Community 9`, `Community 19`, `Community 117`, `Community 24`, `Community 122`, `Community 91`, `Community 94`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `IngestTranscriptCue` connect `Community 1` to `Community 2`, `Community 6`, `Community 10`, `Community 86`, `Community 156`?**
