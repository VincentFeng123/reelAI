...
## Corpus Check
- 388 files · ~1,065,930 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6655 nodes · 18038 edges · 203 communities detected
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 6230 edges (avg confidence: 0.5)
...
- `Fetch a timestamped transcript from Supadata (no audio download).      Synthesiz` --uses--> `PipelineError`  [INFERRED]
  backend/pipeline/transcribe.py → backend/app/clip_engine/clipper/errors.py
...
Cohesion: 0.02
Nodes (142): _energy_min_snap(), _ensure_audio(), _gap_after(), _gap_before(), _pick_end(), _pick_start(), Precise boundary refinement with targeted Whisper.  Supadata gives fast but coar, Absolute time of the lowest-RMS ``frame_ms`` frame within ``[a, b]`` — the quiet (+134 more)
...
Cohesion: 0.02
Nodes (133): extract_concepts(), _extract_concepts_via_llm(), Extract higher-quality concepts via Gemini (falling back to Groq)., _summary_for_terms(), _adapt_query_for_postgres(), _connect_postgres_with_retry(), _database_url(), _db_path() (+125 more)
...
- **Why does `ReelService` connect `Community 4` to `Community 64`, `Community 1`, `Community 7`, `Community 10`, `Community 49`, `Community 91`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Sentence` connect `Community 0` to `Community 96`, `Community 1`, `Community 100`, `Community 5`, `Community 6`, `Community 101`, `Community 9`, `Community 18`, `Community 117`, `Community 22`, `Community 122`, `Community 94`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `IngestTranscriptCue` connect `Community 1` to `Community 89`, `Community 155`, `Community 4`?**
