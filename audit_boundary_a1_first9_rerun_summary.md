# Mass clip audit — suffix=boundary_a1_first9_rerun

- total rows: 3
- clean rows (whisper measured): 3
- error rows: 0
...
|---|---|---|---|
| starts_mid_word | 0 | 3 | 0.000 |
| ends_mid_sentence | 0 | 3 | 0.000 |
| starts_on_filler | 0 | 3 | 0.000 |
| **usable_clip_rate** | 3 | 3 | **1.000** |
