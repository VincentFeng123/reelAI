...
# refine / multimodal. The guarded hybrid route accepts only green Flash results and falls back
# to Pro for uncertain or invalid output. Boundaries are fine-snapped onto supadata's interpolated
# per-word times when SEGMENT_FINE_SNAP is on.
...
try:
    _segment_hybrid_percent = float(os.environ.get("SEGMENT_HYBRID_PERCENT", "1"))
except ValueError:
