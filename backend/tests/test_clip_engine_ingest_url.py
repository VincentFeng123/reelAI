...
class ClipEngineIngestUrlTests(unittest.TestCase):
    ...
    def test_ingest_url_selects_first_ranked_clip_regardless_of_duration(self) -> None:
        ...
        multi_clip_engine_out = {
            ...
            "clips": [
                {
                    ...
                    "substantive": True,
                    "factually_grounded": True,
                    "topic_evidence_quote": "A sample mean estimates the population mean",
                    "cue_ids": ["cue-0"],
                    "sequence_index": 0,
                    "embed_url": "",
                },
                {
                    ...
                    "substantive": True,
                    "factually_grounded": True,
                    "topic_evidence_quote": "A confidence interval quantifies uncertainty",
                    "cue_ids": ["cue-1"],
                    "sequence_index": 1,
                    "embed_url": "",
                },
            ...
            "transcript": {
                "segments": [
                    {"cue_id": "cue-0", "start": 0.0, "end": 20.0, "text": "A sample mean estimates the population mean using observed data."},
                    {"cue_id": "transition", "start": 20.0, "end": 30.0, "text": "Moving to the next concept."},
                    {"cue_id": "cue-1", "start": 30.0, "end": 74.0, "text": "A confidence interval quantifies uncertainty around the estimated population mean."},
                ],
                "words": [],
                "duration": 212.0,
                "source": "supadata",
