...
def test_previous_context_aligned_contract_remains_viewable() -> None:
    ...
    context["selection_contract_version"] = "quality_silence_v30"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    context["selection_contract_version"] = "quality_silence_v29"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    context["selection_contract_version"] = "quality_silence_v28"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    context["selection_contract_version"] = "quality_silence_v27"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    context["selection_contract_version"] = "quality_silence_v25"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    ...
    context["selection_contract_version"] = "quality_silence_v22"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    context["selection_contract_version"] = "quality_silence_v21"

    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is True
    context["selection_contract_version"] = "quality_silence_v20"
    assert silence.persisted_boundary_is_usable(
        context, t_start=2.0, t_end=9.0
    ) is False
