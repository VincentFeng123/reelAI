...
def assess_educational_quality(
    ...
    # Mirrors the production KNOWN_EDUCATIONAL_CHANNELS set in reels.py
    known_edu = [
        # Math
        ...
        'everyday astronaut', 'pbs space time', 'sabine hossenfelder',
        'scott manley',
        # Engineering
        ...
        # Short aliases for broad matching
        'mit', 'ted', 'pbs',
    ]
