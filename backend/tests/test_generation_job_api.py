...
def test_fresh_inventory_and_selector_cache_share_current_contract() -> None:
    ...
    assert segment_cache.SELECTION_CONTRACT_VERSION == "quality_silence_v24"
...
def test_generation_job_reels_promote_internal_current_metadata_and_source(
    ...
    monkeypatch.setattr(
        ...
        lambda *_args, **_kwargs: [{
            ...
            "score": 0.93,
            "relevance_score": 0.13,
            "_selection_contract_version": "quality_silence_v24",
            "_selection_topic_relevance": 0.93,
    ...
    try:
        ...
        assert reels[0]["selection_contract_version"] == "quality_silence_v24"
