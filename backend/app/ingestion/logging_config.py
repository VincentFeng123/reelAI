...
Durable generation events are persisted by the database-backed job repository;
this module is intentionally limited to request trace logging.
"""
...
def log_event(logger: logging.Logger, level: int, event: str, **fields: Any) -> None:
    ...
    The JSON payload always includes `trace_id`. Use this for ingest lifecycle events — especially `ingest_completed`,
