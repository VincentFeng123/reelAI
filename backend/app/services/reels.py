...
class ReelService:
    ...
    # v21: require AI-planned discovery and progressive start-silence verification.
    RANKED_FEED_CACHE_VERSION = 21
    RANKED_FEED_CACHE_CONTRACT_VERSION = "quality_silence_v11"
