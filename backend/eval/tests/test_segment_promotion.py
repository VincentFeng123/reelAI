...
def test_profile_selection_is_single_first_and_uses_eligible_pro_baseline():
    ...
    selection = P.select_evaluation_profiles(
        comparison, passed("flash_single_v1"), passed("flash_split_v3"))
    ...
    selection = P.select_evaluation_profiles(comparison, failed, passed("flash_split_v3"))
    assert selection["selected_flash_profile"] == "flash_split_v3"
